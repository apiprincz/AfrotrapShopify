  ...
  return (
    <IndexLayout>
      ...
      >
        ...
        >
          <span className="text-white">Hoodies</span> / Men's Collections
        </h1>
        {/* <Notify /> */}
        <div className={` col-md-12 ${Styles.productContainer}`}>
          {products
            .filter(
              (product) =>
                product.variants[0].selectedOptions[1].value === "men"
            )
            .map((product, index) => {
              return (
                <div
                  ...
                  className={` col-md-4 col-sm-12 ${Styles.product} pb-2`}
                >
...
export default connect((state) => state)(men);
